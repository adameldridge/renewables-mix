...
def update():
    ...
    curs.execute("CREATE TABLE IF NOT EXISTS generation_mix(" +
                 ...
                 "end_date text," + "biomass real," + "coal real," +
                 "imports real," + "gas real," + "nuclear real," +
                 "other real," + "hydro real," + "solar real," + "wind real);")

    conn.commit()

    # Insert values into table
    curs.execute(
        "INSERT INTO generation_mix(" + "start_date," + "end_date," +
        "biomass," + "coal," + "imports," + "gas," + "nuclear," + "other," +
        "hydro," + "solar," +
        "wind) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);",
        (start_date, end_date, biomass, coal, imports, gas, nuclear, other,
         hydro, solar, wind))
